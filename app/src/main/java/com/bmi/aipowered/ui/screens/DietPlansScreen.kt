...
enum class DietCategory(val label: String, val emoji: String) {
...
fun DietPlansScreen(
    ...
    val dietPlans = viewModel.dietPlans.value
    val isLoadingDiet = viewModel.isLoadingDietPlans.value
    ...
    Box(
        ...
        ScalingLazyColumn(
            ...
            if (selectedCategory == null) {
                    ...
                    item {
                        GradientButton(
                            ...
                            onClick = {
                                ...
                                viewModel.generateDietPlansForCategory(category)
                            },
                ...
                // Show selected category and plans
                item {
                    Row(
                        modifier = Modifier.fillMaxWidth(0.95f),
                ...
                item {
                    ...
                    GradientButton(
                        ...
                        onClick = {
                            viewModel.generateAIDietPlan(selectedCategory!!)
                        },
                        enabled = !isLoadingDiet,
                        modifier = Modifier.fillMaxWidth(0.95f)
                    )
                    Spacer(modifier = Modifier.height(8.dp))
                }
...
@Composable
private fun DietPlanCard(plan: String) {
    Box(
        modifier = Modifier
            .fillMaxWidth(0.95f)
            .background(
