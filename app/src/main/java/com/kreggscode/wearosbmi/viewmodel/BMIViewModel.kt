...
class BMIViewModel : ViewModel() {
    ...
    fun generateDietPlansForCategory(dietCategory: com.kreggscode.wearosbmi.ui.screens.DietCategory) {
        _isLoadingDietPlans.value = true
        viewModelScope.launch {
            try {
    ...
    fun generateAIDietPlan(dietCategory: com.kreggscode.wearosbmi.ui.screens.DietCategory) {
        _isLoadingDietPlans.value = true
        viewModelScope.launch {
            try {
                val plans = aiService.getDietPlansForCategory(
    ...
    fun generateMealPlansForCategory(mealCategory: com.kreggscode.wearosbmi.ui.screens.MealCategory) {
    ...
    fun generateAIMealPlansForCategory(mealCategory: com.kreggscode.wearosbmi.ui.screens.MealCategory) {
        _isLoadingMealPlans.value = true
        viewModelScope.launch {
            try {
                val meals = aiService.getMealPlansForCategory(
    ...
    private fun getPlaceholderDietPlansForCategory(dietCategory: com.kreggscode.wearosbmi.ui.screens.DietCategory): List<String> {
        return when (dietCategory) {
            com.kreggscode.wearosbmi.ui.screens.DietCategory.WEIGHT_LOSS -> listOf(
            ...
            com.kreggscode.wearosbmi.ui.screens.DietCategory.WEIGHT_GAIN -> listOf(
            ...
            com.kreggscode.wearosbmi.ui.screens.DietCategory.MUSCLE_GAIN -> listOf(
            ...
            com.kreggscode.wearosbmi.ui.screens.DietCategory.MAINTENANCE -> listOf(
    ...
    private fun getPlaceholderMealPlansForCategory(mealCategory: com.kreggscode.wearosbmi.ui.screens.MealCategory): List<String> {
        return when (mealCategory) {
            com.kreggscode.wearosbmi.ui.screens.MealCategory.WEIGHT_LOSS -> listOf(
                "Breakfast: Oatmeal with berries",
                "Lunch: Grilled chicken salad",
                "Dinner: Baked fish with veggies",
                "Snacks: Apple, green tea"
            )
            com.kreggscode.wearosbmi.ui.screens.MealCategory.WEIGHT_GAIN -> listOf(
                "Breakfast: Scrambled eggs with toast",
                "Lunch: Pasta with meat sauce",
                "Dinner: Beef stir-fry with rice",
                "Snacks: Greek yogurt, almonds"
            )
            com.kreggscode.wearosbmi.ui.screens.MealCategory.MUSCLE_GAIN -> listOf(
                "Breakfast: Protein pancakes",
                "Lunch: Chicken breast with quinoa",
                "Dinner: Salmon with sweet potato",
                "Snacks: Protein shake, trail mix"
            )
            com.kreggscode.wearosbmi.ui.screens.MealCategory.HEALTHY_MEALS -> listOf(
                "Breakfast: Greek yogurt with berries",
                "Lunch: Quinoa salad with vegetables",
                "Dinner: Grilled fish with brown rice",
                "Snacks: Fresh fruits, nuts"
            )
            com.kreggscode.wearosbmi.ui.screens.MealCategory.QUICK_MEALS -> listOf(
